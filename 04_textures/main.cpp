...
float vertices[] = {
    //     ---- 位置 ----       ---- 颜色 ----     - 纹理坐标 -
    0.0f, 0.5f, 0.0f, 1.0f, 0.0f, 0.0f, 0.5f, 1.0f,   // 上
...
int main()
{
    ...
    // 初始化纹理
    texture = initTexture("D:\\workplace\\opengl\\04_textures\\wall.jpg", GL_RGB, texParameter1, sizeof(texParameter1));
